                ...
                filteredContacts.map((contact, index) => {
                  ...
                  return (
                    <div
                      ...
                      className={` flex flex-row hover:bg-[#2E333D] rounded-3xl h-24 w-full m-auto cursor-pointer relative hover:text-black  transition ease-in-out delay-150 hover:translate-y-1 hover:scale-95 duration-500 ${
